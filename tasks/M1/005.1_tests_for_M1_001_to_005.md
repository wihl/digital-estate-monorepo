...
## Definition of Done
- [x] New tests exist for M1-001..M1-005 behaviors
- [x] `make test` fails on test failure (no swallowing)
- [x] Any required env var overrides are documented in README or DECISIONS.md
- [x] No unrelated refactors
- [x] Task file marked complete in the same commit as the test additions
